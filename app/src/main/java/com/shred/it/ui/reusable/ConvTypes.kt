...
// Define comprehensive lists of formats for each category
val imageFormats = listOf(
    "PNG", "JPEG", "WEBP", "SVG", "HEIC", "AVIF", "HDR"
)

val documentFormats = listOf(
    "PDF", "DOCX", "TXT", "XLSX", "PPTX", "HTML",  "RTF",  "CSV", "XML", "JSON", "MD"
)

val audioFormats = listOf(
    "MP3", "WAV", "FLAC", "AAC", "OGG", "M4A", "WMA", "AIFF", "ALAC", "OPUS", "APE", "AMR", "MIDI"
)

val videoFormats = listOf(
    "MP4", "AVI", "MKV", "MOV", "WMV", "FLV", "WEBM", "MPEG", "3GP", "TS", "M4V", "OGV", "SWF"
)
